...
export default function QuoteGenerator() {
  ...
  return (
    <div>
      <div className="fixed bottom-80 font-merri lg:flex lg:flex-col items-center w-full">
        <blockquote className="bg-slate-600/50 mx-6 max-w-5xl p-6 rounded-xl shadow-lg">
        ...
        <button
          onClick={chooseQuote}
          className="bg-blue-500 py-3 px-4 m-8 rounded-3xl shadow-lg bg-orange-800 ease-in-out duration-200 hover:cursor-pointer hover:bg-orange-900"
        >
          Click for Iroh wisdom
        </button>
      </div>
